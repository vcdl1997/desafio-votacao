...
import br.tec.db.desafio_votacao.application.controller.v1.docs.SessaoV1VotacaoApiDocs;
...
public class SessaoVotacaoV1Controller implements SessaoV1VotacaoApiDocs {
	...
	@GetMapping("/{id}")
	public ResponseEntity<SessaoVotacaoResponseDTO> obterPorId(final @PathVariable(name = "id") Long id){
