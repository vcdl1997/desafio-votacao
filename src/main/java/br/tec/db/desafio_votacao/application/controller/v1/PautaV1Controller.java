...
import br.tec.db.desafio_votacao.application.controller.v1.docs.PautaV1ApiDocs;
...
public class PautaV1Controller implements PautaV1ApiDocs {
	...
	@GetMapping("/{id}")
	public ResponseEntity<PautaResponseDTO> obterPorId(final @PathVariable(name = "id") Long id){
